...
sealed class Achievement(
    ...
    companion object {
        fun create(id: Int, progress: Int): Achievement = when (id) {
            OpenTheoryAchievement.ID -> OpenTheoryAchievement(
                progress
            )
            RateAppAchievement.ID -> RateAppAchievement(
                progress
            )
            LearnedSentencesAchievement.ID -> LearnedSentencesAchievement(
                progress
            )
            ComboTestAchievement.ID -> ComboTestAchievement(
                progress
            )
            EntireCorrectTestAchievement.ID -> EntireCorrectTestAchievement(
                progress
            )
            PassTestAchievement.ID -> PassTestAchievement(
                progress
            )
